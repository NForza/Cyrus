...
internal class ModelGenerator
{
    internal static string ForHub(SignalRHubClassDefinition signalRHub, Compilation compilation)
    {
        ...
        var queries = signalRHub.Queries.Select(c => $"new ModelQueryDefinition(\"{c.Name}\", \"{c.ReturnType}\", {c.ReturnsCollection.ToString().ToLower()}, {c.ReturnsNullable.ToString().ToLower()})");
