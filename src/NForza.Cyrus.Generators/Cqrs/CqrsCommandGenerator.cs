    ...
    public override void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(third, (spc, source) =>
        {
            ...
            if (config != null && recordSymbols.Any())
            {
                ...
                var commandModels = GetPartialModelClass(assemblyName, "Commands", "ModelTypeDefinition", recordSymbols.Select(cm => ModelGenerator.ForNamedType((INamedTypeSymbol)cm.Parameters[0].Type)));
