...
public class SolutionContext(CyrusGenerationContext cyrusGenerationContext, ImmutableArray<ISymbol> allCommandsAndHandlers, ImmutableArray<ISymbol> allQueriesAndHandlers, ImmutableArray<INamedTypeSymbol> allEvents, ImmutableArray<INamedTypeSymbol> allValueTypes)
{
    ...
    public ImmutableArray<INamedTypeSymbol> Events => allEvents;
